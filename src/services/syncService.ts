...
const mapProject = (row: any, profiles: any[]): Project => ({
  ...
  resourceLinks: Array.isArray(row.resource_links) ? row.resource_links : [], briefFileName: row.brief_file_name || undefined, briefStoragePath: row.brief_storage_path || undefined, briefUploadedAt: row.brief_uploaded_at || undefined, lastActivityAt: iso(row.last_activity_at),
});
...
export const toDatabase = {
  project: (project: Project) => ({ id: project.id, company_name: project.companyName, folder_name: project.code, title: project.title, challenge_description: project.challengeDescription || null, whatsapp_url: project.whatsappUrl || null, teams_meeting_url: project.teamsMeetingUrl || null, min_students: project.minStudents, max_students: project.maxStudents, progress_status: project.progressStatus || null, progress_pct: project.progressPct, risk_level: project.riskLevel, organization_contacts: project.contacts, resource_links: project.resourceLinks || [], ai_type: project.aiType, complexity_rating: project.complexityRating, github_url: project.githubUrl || null, drive_folder_url: project.driveFolderUrl || null, brief_file_name: project.briefFileName || null, brief_storage_path: project.briefStoragePath || null, brief_uploaded_at: project.briefUploadedAt || null, last_activity_at: project.lastActivityAt }),
